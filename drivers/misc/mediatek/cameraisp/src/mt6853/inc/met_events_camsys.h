...
TRACE_EVENT(camsys_rrz_cfg,
	TP_PROTO(unsigned int dummy),
	TP_ARGS(dummy),
	TP_STRUCT__entry(
	...
	TP_printk("dummy=%u", __entry->dummy)
);
...
#define trace_ISP__Pass1_CAM_enter(...)
#define trace_ISP__Pass1_CAM_enter_enabled() (0)
#define trace_ISP__Pass1_CAM_leave(...)
#define trace_ISP__Pass1_CAMSV_enter(...)
#define trace_ISP__Pass1_CAMSV_leave(...)
